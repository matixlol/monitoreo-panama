...
const chartPanelCss = `:host{display:block;min-width:0;color:#111827;}.wc-panel{display:grid;gap:16px;padding:16px;background:#f8f8f8;border-radius:12px}.wc-title{margin:0;font:inherit;font-size:clamp(1.95rem,4vw,2.5rem);font-weight:500;line-height:1.05;letter-spacing:-.04em;overflow-wrap:anywhere}.wc-body,.wh-chart,.wc-chart-slot{min-width:0}.wc-body--bare{display:grid;gap:12px;min-width:0}.wc-chart-slot{display:grid;animation:wc-tab-panel-in .18s ease both}.loading,.error,.empty{padding:14px 0;color:#667085}@keyframes wc-tab-panel-in{0%{opacity:.32;transform:translateY(6px)}100%{opacity:1;transform:translateY(0)}}@media (max-width:720px){.wc-panel{gap:14px;padding:14px}.wc-title{font-size:clamp(1.5rem,8vw,2rem)}}`;
const chartElementCss = `${chartPanelCss}.wc-controls{display:flex;flex-wrap:wrap;gap:10px;align-items:end;margin:0 0 12px}.wc-field{display:grid;gap:4px;min-width:180px;color:#344054;}.wc-field select{padding:8px 12px;border:1px solid #e4e7ec;border-radius:999px;background:#fff;color:#344054;}${bootstrapTabsCss}.mf-map{overflow-x:auto;overflow-y:hidden}.mf-map svg{display:block;width:100%;height:auto;max-width:960px;margin:auto}.legend{display:flex;align-items:center;gap:10px;margin-top:10px;color:#667085;}.mf-grad{height:12px;flex:1;max-width:300px;border-radius:999px;background:linear-gradient(90deg,#eff6ff,#1d4ed8)}.mf-parity-layout{display:grid;gap:24px;align-items:start;grid-template-columns:minmax(0,1.7fr) minmax(210px,.65fr)}.mf-parity-layout__map,.mf-parity-layout__breakdown{min-width:0}.mf-parity-layout__breakdown{display:grid;align-content:start}@media (max-width:1040px){.mf-parity-layout{grid-template-columns:1fr}}${groupedBarsChartCss}`;
